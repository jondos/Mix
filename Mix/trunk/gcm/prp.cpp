...
void aes_ctr_first(UINT32 rk[64], UINT8 nonce[12], UINT32 *ctr, UINT8 ct[16], int klen) {
...
void aes_ctr(UINT32 rk[64], UINT32 ctr[1], UINT8 ct[16], int klen) {
  UINT32 s0, s1, s2, s3, t0, t1, t2, t3;
...
void aes_enc(const UINT32 rk[], const UINT8 pt[16], UINT8 ct[16], int klen) {
  UINT32 s0, s1, s2, s3, t0, t1, t2, t3;
